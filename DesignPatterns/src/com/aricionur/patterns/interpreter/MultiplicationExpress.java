...
public class MultiplicationExpress extends Expression{

	public MultiplicationExpress(String formul) {
	...
	private int[] parse(String formul) {
		...
		String[] numbers = formul.split(OperationType.MULTIPLICATION);
